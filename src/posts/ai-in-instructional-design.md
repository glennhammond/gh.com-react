...
1) Define the performance problem clearly (what people must do differently).  
2) Use AI to draft options, not decisions.  
3) Keep your design principles explicit (e.g., ADDIE-aligned, accessibility-aware, assessment mapped).  
4) Validate everything that claims to be factual.

If you treat AI as a collaborator that accelerates the messy early stage, you get the benefits without sacrificing quality.
