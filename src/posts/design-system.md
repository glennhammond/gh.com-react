...
### **3. Colour tokens**
Brand colours expressed as semantic roles:

| Token | Colour | Purpose |
|-------|--------|---------|
| `--brand-primary` | Green | Buttons, highlights |
...
This design system is becoming the backbone of all new learning products — and it’s only getting better from here.